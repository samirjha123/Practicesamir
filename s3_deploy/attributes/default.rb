efault[:mvn_s3_deploy][:access_key_id] = "YOUR_KEY_HERE"
...
default[:mvn_s3_deploy][:war_name] = "samir.war" # The name of the file as it will reside in the webapps directory and by default, the context name for the application
